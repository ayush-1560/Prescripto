...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row bg-primary rounded-lg px-6 md:px-10 lg:px-14'>
      {/* Left-Side */}
      ...
      <div className='md:w-1/2 relative'>
        <img
          className='w-full h-auto md:max-w-[90%] md:absolute md:bottom-0 md:right-0 rounded-lg'
